...
class Pipes(pygame.sprite.Sprite): 
	...
	def move_pipes(self): 
		if self.did_collide != True: 
			newpos = self.bottom_rect.move(-3, 0)
			self.bottom_rect = newpos

			newpos = self.top_rect.move(-3, 0)
...
def display_credits_screen(): 
	credits_string = "Flap"
	programmer_string = "Created by Rory O'Connor"
	background_string = "Background Image"
	background_string2 = "Asian Mountain Forest BG" 
	background_string3 = "By Crisisworks"
	sprites = "Sprites"
	sprite_string = "The original Flappy Bird sprite by Dong Nguyen"
	sprite_string2 = "was used for the bird"
	pipe_string = "The original Mario pipe sprite was used"
	pipe_string2 = "for the pipes as well"
	main_menu_string = "Press M to return to the main menu"

	message_to_screen(credits_string, black, -250, "large")
	message_to_screen(programmer_string, black, -200, "small")

	message_to_screen(background_string, black, -100, "medium")
	message_to_screen(background_string2, black, -60, "small")
	message_to_screen(background_string3, black, -40, "small")

	message_to_screen(sprites, black, 40, "medium")
	message_to_screen(sprite_string, black, 90, "small")
	message_to_screen(sprite_string2, black, 110, "small")
	message_to_screen(pipe_string, black, 150, "small")
	message_to_screen(pipe_string2, black, 170, "small")

	message_to_screen(main_menu_string, black, 270, "small")
